		...
		<div class="modal-content" component="chat/message/window">
			<div class="modal-header d-flex gap-4 justify-content-between">
				...
				<div class="d-flex gap-1 align-items-center">
					<button type="button" class="btn btn-ghost btn-sm d-none d-md-flex" data-action="maximize" title="{{tx("modules:chat.maximize")}}" data-bs-toggle="tooltip" data-bs-placement="bottom">
