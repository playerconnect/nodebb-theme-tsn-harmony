...
<form class="edit-form">
	...
	{{{ if isSelf }}}
	<div class="mb-2">
		<label class="form-label fw-semibold text-xm" for="inputCurrentPassword">{{tx("user:current-password")}}</label>
	...
	<div class="mb-2">
		<label class="form-label fw-semibold text-xm" for="inputNewPassword">{{tx("user:new-password")}}</label>
	...
	<div class="mb-2">
		<label class="form-label fw-semibold text-xm" for="inputNewPasswordAgain">{{tx("user:confirm-password")}}</label>
