					...
					<form component="register/local" class="d-flex flex-column gap-3" role="form" action="{config.relative_path}/register" method="post">
						<div class="mb-2 d-flex flex-column gap-2">
							...
							<div class="d-flex flex-column">
								<input class="form-control" type="text" placeholder="{{tx("register:username-placeholder")}}" name="username" id="username" autocorrect="off" autocapitalize="off" autocomplete="off" />
						...
						<div class="mb-2 d-flex flex-column gap-2">
							...
							<div class="d-flex flex-column">
								<input class="form-control" type="password" placeholder="{{tx("register:password-placeholder")}}" name="password" id="password" />
						...
						<div class="mb-2 d-flex flex-column gap-2">
							...
							<div>
								<input class="form-control" type="password" placeholder="{{tx("register:confirm-password-placeholder")}}" name="password-confirm" id="password-confirm" />
