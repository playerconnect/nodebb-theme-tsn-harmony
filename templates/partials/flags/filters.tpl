<div component="flags/filters" class="d-flex flex-wrap gap-2 pb-3 border-bottom">
	<div class="btn-group bottom-sheet">
		...
		<ul class="dropdown-menu p-1 text-sm">
			<li>
				<a class="dropdown-item rounded-1" href="{config.relative_path}/flags?quick=mine">{{tx("flags:filter-quick-mine")}}</a>
			</li>
		</ul>
	</div>
	...
	<div class="btn-group bottom-sheet">
		...
		<ul class="dropdown-menu p-1 text-sm">
			...
			<li class="dropdown-item rounded-1" data-name="sort" data-value="newest">{{tx("flags:sort-newest")}}</li>
			<li class="dropdown-item rounded-1" data-name="sort" data-value="oldest">{{tx("flags:sort-oldest")}}</li>
			<li class="dropdown-item rounded-1" data-name="sort" data-value="reports">{{tx("flags:sort-reports")}}</li>
			<li><h6 class="dropdown-header">{{tx("flags:sort-posts-only")}}</h6></li>
			<li class="dropdown-item rounded-1" data-name="sort" data-value="downvotes">{{tx("flags:sort-downvotes")}}</li>
			<li class="dropdown-item rounded-1" data-name="sort" data-value="upvotes">{{tx("flags:sort-upvotes")}}</li>
			<li class="dropdown-item rounded-1" data-name="sort" data-value="replies">{{tx("flags:sort-replies")}}</li>
		</ul>
	</div>
	...
	<div class="btn-group bottom-sheet">
		...
		<ul class="dropdown-menu p-1 text-sm">
			<li class="dropdown-item rounded-1" data-name="state" data-value="open">{{tx("flags:state-open")}}</li>
			<li class="dropdown-item rounded-1" data-name="state" data-value="wip">{{tx("flags:state-wip")}}</li>
			<li class="dropdown-item rounded-1" data-name="state" data-value="resolved">{{tx("flags:state-resolved")}}</li>
			<li class="dropdown-item rounded-1" data-name="state" data-value="rejected">{{tx("flags:state-rejected")}}</li>
		</ul>
	</div>
	...
	<div class="btn-group bottom-sheet">
		...
		<ul class="dropdown-menu p-1 text-sm">
			<li class="dropdown-item rounded-1" data-name="type" data-value="all">{{tx("flags:filter-type-all")}}</li>
			<li class="dropdown-item rounded-1" data-name="type" data-value="post">{{tx("flags:filter-type-post")}}</li>
			<li class="dropdown-item rounded-1" data-name="type" data-value="user">{{tx("flags:filter-type-user")}}</li>
		</ul>
	</div>
