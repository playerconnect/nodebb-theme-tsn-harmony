<div class="options">
	<form component="groups/settings" role="form">
		<div class="row">
			...
			<div class="col-12 col-lg-6">
				<div class="d-flex gap-2 align-items-center">
					<div class="form-check">
						<label class="form-check-label">{{tx("groups:details.userTitleEnabled")}}</label>
				...
				<div class="mb-2">
					<label class="form-label text-xs text-muted" for="userTitle">{{tx("groups:details.badge-text")}}</label>
					<div class="d-flex gap-1">
						...
						<button component="groups/userTitleOption" type="button" class="btn btn-outline-secondary text-nowrap" data-action="icon-select"{{{ if !group.userTitleEnabled }}} disabled{{{ end }}}>{{tx("groups:details.change-icon")}}</button>
				...
				<div class="mb-2">
					<label class="form-label text-xs text-muted" for="labelColor" class="badge-color-label">{{tx("groups:details.change-label-colour")}}</label>
				...
				<div class="mb-2">
					<label class="form-label text-xs text-muted" for="color" class="badge-color-label">{{tx("groups:details.change-text-colour")}}</label>
		...
		<button class="btn btn-link text-danger float-end" type="button" data-action="delete">{{tx("groups:details.delete-group")}}</button>
		<button class="btn btn-primary" type="button" data-action="update">{{tx("global:save-changes")}}</button>
	</form>
</div>
