				...
				<td class="member-name p-2 w-100 ">
					<div class="d-flex align-items-center justify-content-between">
						...
						<div class="owner-controls d-flex gap-1">
							<a class="btn btn-light btn-sm" href="#" data-ajaxify="false" data-action="toggleOwnership" title="{{tx("groups:details.grant")}}">
								<i class="fa fa-star text-warning"></i>
							</a>

							<a class="btn btn-light btn-sm" href="#" data-ajaxify="false" data-action="kick" title="{{tx("groups:details.kick")}}">
