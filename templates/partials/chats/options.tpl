<div class="d-flex gap-1 align-items-stretch">
	...
	<!-- pinned messages -->
	<button component="chat/pinned/messages/btn" class="btn btn-ghost btn-sm d-none d-lg-flex flex-nowrap" title="[[modules:chat.pinned-messages]]" data-bs-toggle="tooltip" data-bs-placement="bottom">
