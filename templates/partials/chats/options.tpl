<div class="d-flex gap-1 align-items-stretch">
	...
	<!-- pinned messages -->
	<button component="chat/pinned/messages/btn" class="btn btn-ghost btn-sm d-none d-lg-flex flex-nowrap" title="{{tx("modules:chat.pinned-messages")}}" data-bs-toggle="tooltip" data-bs-placement="bottom">
	...
	<!-- users toggle -->
	{{{ if users.length }}}
	<div component="chat/user/list/btn" class="btn btn-ghost btn-sm d-none d-lg-flex flex-nowrap gap-3" title="{{tx("modules:chat.view-users-list")}}" data-bs-toggle="tooltip" data-bs-placement="bottom">
